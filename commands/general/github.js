...
module.exports = {
    ...
    async execute(sock, msg, args, extra) {
        try {
            ...
            const repoUrl = 'https://github.com/mrmuneebali907-byte/Mr.-Muneeb.-Ali';
            const apiUrl = 'https://api.github.com/repos/mrmuneebali907-byte/Mr.-Muneeb.-Ali';
    ...
    headers: {
        'User-Agent': 'Mr-Muneeb-Bot'
                ...
                fallbackMessage += `🔗 *Repository:* Mr.-Muneeb.-Ali\n`; 
                fallbackMessage += `👨‍💻 *Owner:* mrmuneebali907-byte\n`;
